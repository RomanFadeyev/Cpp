// GradientBarSkin.cpp : Defines the initialization routines for the DLL.
//
...
BEGIN_MESSAGE_MAP(CGradientBarSkinApp, CWinApp)
	//{{AFX_MSG_MAP(CGradientBarSkinApp)
...
/////////////////////////////////////////////////////////////////////////////
// CGradientBarSkinApp construction

CGradientBarSkinApp::CGradientBarSkinApp()
{
}

/////////////////////////////////////////////////////////////////////////////
// The one and only CGradientBarSkinApp object

CGradientBarSkinApp theApp;
...
CRuntimeClass* __stdcall BCGCBGetSkinClass (int iIndex)
{
	...
	{
	case 0:
		return RUNTIME_CLASS (CGradientBar);
...
BOOL __stdcall BCGCBPreviewSkin (CDC* pDC, int iIndex, CRect rectPreview)
{
	...
	case 0:
		{ 
			CBitmap bmpPreview;
			bmpPreview.LoadBitmap (IDB_GRADIENTBAR_PREVIEW);
