// GradientButtonSkin.cpp : Defines the initialization routines for the DLL.
//
...
/////////////////////////////////////////////////////////////////////////////
// CGradientButtonSkinApp

BEGIN_MESSAGE_MAP(CGradientButtonSkinApp, CWinApp)
	//{{AFX_MSG_MAP(CGradientButtonSkinApp)
...
/////////////////////////////////////////////////////////////////////////////
// CGradientButtonSkinApp construction

CGradientButtonSkinApp::CGradientButtonSkinApp()
{
}

/////////////////////////////////////////////////////////////////////////////
// The one and only CGradientButtonSkinApp object

CGradientButtonSkinApp theApp;
...
CRuntimeClass* __stdcall BCGCBGetSkinClass (int iIndex)
{
	...
	{
	case 0:
		return RUNTIME_CLASS (CGradinetButton);
...
BOOL __stdcall BCGCBPreviewSkin (CDC* pDC, int iIndex, CRect rectPreview)
{
	...
	case 0:
		{
			CBitmap bmpPreview;
			bmpPreview.LoadBitmap (IDB_GRADINETBUTTON_PREVIEW);
