// SilverRingSkin.cpp : Defines the initialization routines for the DLL.
//
...
BEGIN_MESSAGE_MAP(CSilverRingSkinApp, CWinApp)
	//{{AFX_MSG_MAP(CSilverRingSkinApp)
...
/////////////////////////////////////////////////////////////////////////////
// CSilverRingSkinApp construction

CSilverRingSkinApp::CSilverRingSkinApp()
{
}

/////////////////////////////////////////////////////////////////////////////
// The one and only CSilverRingSkinApp object

CSilverRingSkinApp theApp;
...
CRuntimeClass* __stdcall BCGCBGetSkinClass (int iIndex)
{
	...
	{
	case 0:
		return RUNTIME_CLASS (CSilverRing);
...
BOOL __stdcall BCGCBPreviewSkin (CDC* pDC, int iIndex, CRect rectPreview)
{
	...
	case 0:
		{
			CBitmap bmpPreview;
			bmpPreview.LoadBitmap (IDB_SILVERRING_PREVIEW);
